      ...
      >
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-2xl">
            <h1 className="text-5xl font-bold mb-4 text-white">Bigotes Pizzería Artesanal Alemana</h1>
            <p className="text-xl mb-8 text-white">Descubre el auténtico sabor de la pizza artesanal con un toque alemán</p>
            <Link
              to="/menu"
